...
public class Xbox {
	...
	public void ListResultCheck() throws Exception {
		...
		m.explicitWait(HomepageX.LINK_LIST);
		m.listCreate("xpath", HomepageX.LINK_LIST);
		m.explicitWait(HomepageX.POPUP_CLOSE2);
	...
	public void SelectItemstoBuyForza() throws Exception {
		...
		m.explicitWait(ListGamePage.FORZA_HORIZ_SELECT);
		m.click("xpath", ListGamePage.FORZA_HORIZ_SELECT);
		m.explicitWait(ListGamePage.ADD_CAR_BTTN);
		m.click("xpath", ListGamePage.ADD_CAR_BTTN);
		m.explicitWait(ListGamePage.CAR_WITH_1ART);
		m.backPage();
	...
	public void SelectItemstoBuyHalo() throws Exception {
		...
		m.explicitWait(ListGamePage.HALO_INFINITE_SELECT);
		m.click("xpath", ListGamePage.HALO_INFINITE_SELECT);
		m.explicitWait(ListGamePage.ADD_CAR_BTTN);
		m.click("xpath", ListGamePage.ADD_CAR_BTTN);
		m.explicitWait(ListGamePage.CAR_WITH_2ART);
		m.backPage();
